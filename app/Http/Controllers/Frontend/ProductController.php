...
class ProductController extends Controller
{
    ...
    public function editProduct($id) {
        ...
        return view('frontend/member/edit-product', compact('brands', 'categories', 'product'));
    }
    ...
    public function deleteProduct($id) {
        $product = Product::FindOrFail($id);
        if($product->delete()) {
            return redirect() -> back() -> with('success', __("Xóa sản phẩm thành công"));
        } else {
            return redirect() -> back() -> withErrors('Xóa sản phẩm thất bại');
        }
    }

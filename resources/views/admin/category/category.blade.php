    ...
    <div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                <div class="col-12">
                                            ...
                                            foreach ($categories as $key => $value) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('admin/category/edit/'.$value->id) }}" class="btn btn-sm btn-primary">Edit</a>
                        ...
                        <a href="{{ url('/admin/category/add') }}"><button class="btn btn-success">Add Category</button></a>
                    </div>
            </div>
@endsection